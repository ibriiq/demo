...
def get_xaliye_info(request, data, headers):
    getXaliyeInformation_url = 'http://192.168.2.19:96/api/values/getXallyeinfo'
    getXaliyeInformation = requests.post(
        getXaliyeInformation_url, json=data, headers=headers)
    getXaliyeInformation = json.loads(getXaliyeInformation.text)
